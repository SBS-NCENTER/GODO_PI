...
Sign convention: **SUBTRACT** (operator-locked 2026-05-04 KST, supersedes 2026-04-30 ADD). 운영자가 입력한 `(x_m, y_m)`은 *새 (0, 0)이 되어야 할 world coord*. 백엔드: `new_yaml_origin = old_yaml_origin − typed`. SPA-side에서 delta → absolute 변환 (PICK#2/#3 HIL 핀). 자세한 내용은 `.claude/memory/feedback_subtract_semantic_locked.md`.
